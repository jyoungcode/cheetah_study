...
|[attribute]|[target]|S|elects all elements with a target attribute|2|
...
|:last-of-type|p:last-of-type|Se3lects every <p> element that is the last <p> element of its parent|3|
